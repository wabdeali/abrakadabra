...
export const fields = (
  <ModuleFields>
    ...
    <FieldGroup name="styles" label="Styles" tab="STYLE">
      <FieldGroup name="text" label="Text">
        <FontField name="font" label="Font" />
      </FieldGroup>
      <FieldGroup name="background" label="Background">
        <ColorField name="color" label="Color" />
      </FieldGroup>
      <FieldGroup name="border" label="Border">
        <BorderField name="border" label="Border" />
      </FieldGroup>
      <FieldGroup name="corner" label="Corner">
        <NumberField
          name="radius"
          label="Radius"
          max={100}
      ...
      <FieldGroup name="spacing" label="Spacing">
        <SpacingField name="spacing" label="Spacing" />
      </FieldGroup>
      <FieldGroup name="alignment" label="Alignment">
        <AlignmentField
          name="alignment"
          label="Alignment"
